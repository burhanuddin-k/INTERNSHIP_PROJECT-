...
![AWS Organizations OU structure](<img width="1900" height="672" alt="2" src="https://github.com/user-attachments/assets/3f9df38d-2baf-4a29-b5a5-69b56b15d15b" />
)
...
![Failed account creation requests](<img width="1917" height="731" alt="3" src="https://github.com/user-attachments/assets/0335354d-f200-45bc-9dc5-94f7ebf76626" />
)

Account creation succeeded on a retry with a unique email, and the account was correctly placed inside the **DEV** OU.

![Dev-Account created under DEV OU](<img width="1830" height="631" alt="4" src="https://github.com/user-attachments/assets/de5474bb-5a7b-4deb-a4cc-bc251ef61784" />
)
...
![Creating DenyLargeEC2InDev policy](<img width="698" height="807" alt="5" src="https://github.com/user-attachments/assets/4d8a269b-1c00-4474-b4bd-f5076b7a4adc" />
)

The policy JSON uses a `Deny` effect with a `StringLike` condition on `ec2:InstanceType`:

![DenyLargeEC2InDev policy JSON](<img width="716" height="708" alt="6" src="https://github.com/user-attachments/assets/6e1ff9be-915d-45fc-9b08-cb62b608ff48" />
)
...
![Attaching DenyLargeEC2InDev](<img width="1542" height="727" alt="7" src="https://github.com/user-attachments/assets/b92592d7-6083-4dc1-ae8c-2dff2b4008a3" />
)

Confirmed via the account's **Policies** tab that 6 policies were now applied (directly, via DEV OU, and via Root).

![Applied policies on Dev-Account](<img width="1540" height="727" alt="8" src="https://github.com/user-attachments/assets/17eb99f8-00c7-45ae-9640-87523b0f23eb" />
)
...
![Dev-Account console home](<img width="1892" height="853" alt="10" src="https://github.com/user-attachments/assets/a183843c-3b48-4894-a994-7a4b4e4880e2" />
)
...
![EC2 launch denied by SCP](<img width="1892" height="853" alt="10" src="https://github.com/user-attachments/assets/e62b7a8e-6d35-43b4-bcce-62a440d382f5" />
)
...
![ProtectCloudTrail policy created](<img width="1905" height="797" alt="12" src="https://github.com/user-attachments/assets/6a97df90-c35b-4d4d-8072-4b3e234568e2" />
)

Attached it at the **Root** level so it applies organization-wide.

![Attach ProtectCloudTrail at Root](<img width="1897" height="798" alt="Screenshot 2026-09-11 003007" src="https://github.com/user-attachments/assets/4855e9b0-29c7-4d08-b369-0433b39c0119" />
)
...
![RestrictAWSRegions policy created](<img width="1911" height="788" alt="Screenshot 2026-09-11 003257" src="https://github.com/user-attachments/assets/12539f28-8b97-48d7-9499-8d9f2375ef1e" />
)
...
![Attach RestrictAWSRegions at Root](<img width="1915" height="791" alt="Screenshot 2026-09-11 003400" src="https://github.com/user-attachments/assets/25376490-8559-4eb2-bc10-88fb05fe64cc" />
)
...
![CloudTrail trail list](<img width="1917" height="867" alt="Screenshot 2026-09-11 005701" src="https://github.com/user-attachments/assets/c68e1945-a2c5-44d6-b748-ffaebeacedeb" />
)

Selected the trail to attempt to stop logging:

![Selecting Governance-Test-Trail](<img width="1917" height="688" alt="Screenshot 2026-09-11 005856" src="https://github.com/user-attachments/assets/853c7f96-6aee-4cd9-ab61-d635c4728fc5" />
)
...
![CloudTrail stop logging denied](<img width="1896" height="860" alt="Screenshot 2026-09-11 010008" src="https://github.com/user-attachments/assets/a6000d7a-af38-4c63-bf8e-f6ec85443286" />
)
...
![EC2 DescribeInstances denied by SCP](<img width="1895" height="807" alt="Screenshot 2026-09-11 010816" src="https://github.com/user-attachments/assets/2b1f09be-7339-4f20-9115-1bba4e194604" />
)
